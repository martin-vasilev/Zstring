...
breaks= [48,97, 144]; % scheduled break
Instr_break= [1, 97]; % point at which to present instructions
...
normal_reading= ['You will now see different short sentences. Your task is to\n' ...
                 ...
                 'them and focus on reading the sentences. When you finish reading,\n'...
                 'press the left button of the mouse to continue.'];
...
zString_reading= ["You will now see a number of short letter strings. Your task is to\n"...
                  ...
                  "letter 'o' appears in them. This letter can appear anywhere\n"...
                  "on the screen, so make sure you scan all strings.\n"...
                  "Every now and then, you will be asked how many times the\n"...
                  "letter 'o' appeared in the strings. Sometimes, you will hear\n"...
                  'short sounds while you do the task. Do your best to ignore\n'...
                  'them and focus on scanning the strings. When you finish,\n'...
                  'press the left button of the mouse to continue.'];
    ...
    if hasQuest
     ...
     if strcmp(task, 'reading')==1 % natural reading
        ...
        answer= QuestionMC(question, strsplit(options, '/n'), ...
         ...
         options= '1)  1 time/n2)  2 times/n3)  3 times/n4)  4 times';
         question= 'How many times did the letter "o" appear in the string?';
